    ...
    <section id="aboutus" class="h-full w-full bg-white dark:bg-black overflow-hidden">
        <div id="aboutusContent" class="p-20">
            <div class="grid grid-cols-12 items-center">
                <p class="col-span-1 font-nunito text-black text-sm dark:text-white ">QUI SUIS-JE ?</p>
            ...
            <div class="grid grid-cols-12 gap-y-6 pb-40 z-[1]">
                <h3 class="colTitle1 text-stone-300 font-antonsc text-[6vw] text-left dark:text-teal-700 flex flex-col col-span-12 uppercase -mb-10">Artiste tatoueuse depuis 6ans</h3>
                ...
                <div class="colTexte flex flex-col-2 col-span-10 col-start-5 my-20 mb-40 font-nunito text-sm uppercase gap-x-6 text-justify text-black dark:text-white">
                    <p class="colTexte1 w-full text-left">Bienvenue dans mon univers artistique où <b>chaque tatouage raconte une histoire unique</b>. Passionnée par l'<i>art du tatouage depuis des années</i>, je mets mon expertise et ma créativité au service de <b>ceux qui souhaitent marquer leur corps de manière indélébile.</b></p>
                    <p class="colTexte2 w-full text-right">Votre sourire, votre manière de parler et votre ressenti m'inspirent dès les premières minutes de notre échange. Ensemble, nous donnerons vie à une œuvre d'art personnelle et intemporelle. Mon objectif est de transformer votre idée en une création qui résonnera avec vous pour toujours.</p>
                </div>
            </div>
        </div>
