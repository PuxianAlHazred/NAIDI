<template>
    <section id="health" class="h-full w-full bg-white dark:bg-black">
        <div id="healthContent" class="lg:p-20">
            <div class="grid grid-cols-12 items-center lg:px-20 lg:pt-0 pt-10 lg:px-20 px-10">
                <p class="lg:col-span-1 col-span-4 font-nunito text-teal-700 text-sm">LES SOINS</p>
                <div class="lg:col-span-11 col-span-8  h-1 bg-teal-700 pixelateMin" />
            </div>
            <div class="grid grid-cols-12 gap-y-6 overflow-hidden py-10  lg:px-20 px-10">
                <h3 class="lg:animate-none animate-pulse lg:px-20 text-teal-700 font-antonsc lg:text-[9vw] text-3xl text-center flex  col-span-12 uppercase justify-between tracking-widest">Prenez <span class="underline text-black dark:text-white">soin</span> de vous</h3>
                <Swiper
