    ...
    <section id="health" class="h-full w-full bg-white dark:bg-black">
        <div id="healthContent" class="py-20">
            ...
            <div class="grid grid-cols-12 gap-y-6 overflow-hidden py-10">
                <h3 class="px-20 text-teal-700 font-antonsc text-[9vw] text-center flex  col-span-12 uppercase justify-between tracking-widest">Prenez <span class="underline text-black dark:text-white">soin</span> de vous</h3>
                <Swiper
                ...
                >
                    <SwiperSlide class="group hover:border-teal-700 border-4 border-stone-300 mx-10 bg-white ml-20  dark:bg-black dark:text-white" >
                    ...
                    <SwiperSlide class="group hover:border-teal-700 border-4 border-stone-300 mx-10 bg-white  dark:bg-black dark:text-white">
                        <div class="flex flex-col justify-between h-full p-6">
                    ...
                    <SwiperSlide class="hover:border-teal-700 border-4 border-stone-100 mx-10 bg-stone-100  dark:bg-black dark:border-black dark:text-white">
